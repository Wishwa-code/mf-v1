            ...
            if (xhr.status === 200) {
                ...
                data.item.forEach(function(item) {
                    ...
                    $('#loan_table').DataTable().row.add([
                        ...
                        parseFloat(item.capital_balance).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 }),
                        parseFloat(item.Total_Loan_Amount).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 }),
                        parseFloat(item.Balance_Amount).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 }),
                        item.Date_Time,
                        item.Date_Time,
