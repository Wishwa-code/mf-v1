    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.edit-btn', function() {
                ...
                const No = editButton.getAttribute('data-canter-no');
                const name = editButton.getAttribute('data-center-name');
                const Contact_no = editButton.getAttribute('data-contact-no');
                const Address = editButton.getAttribute('data-address');
                const route = editButton.getAttribute('data-route');
                const center_incharge = editButton.getAttribute('data-center-incharge');
                const center_id = editButton.getAttribute('data-center-id');


                // Set the values of the input fields
                document.getElementById('center_number').value = No;
                document.getElementById('center_name').value = name;
                document.getElementById('contact').value = Contact_no;
                document.getElementById('address').value = Address;
                document.getElementById('route').value = route;
                document.getElementById('center_incharge').value = center_incharge;
                document.getElementById('center_id').value = center_id;
