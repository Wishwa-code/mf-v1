        ...
        <div class="row mt-3">
            <div class="col-12">
                <div class="page-header">
                    <h3 class="mb-0"><i class="ri-file-list-3-line me-2"></i>Pending Vouchers</h3>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="mb-3"><i class="ri-time-line me-2"></i>Pending Vouchers List</h5>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-success" id="approveVoucherBtn"><i class="ri-checkbox-circle-line me-1"></i>Approve Voucher</button>
                </div>
            </div>
        </div>
    </div>
