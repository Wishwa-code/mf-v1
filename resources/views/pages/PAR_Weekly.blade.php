    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('partweeklyview.create') }}" method="post">
                            @csrf
                            <div class="col-lg-3">
                                <div class="mb-2">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-4">
                                <div class="card text-white bg-info mb-3">
                                    <div class="card-header" style="color: black">PAR 7 Days</div>
                                    <div class="card-body">
                            ...
                            <div class="col-md-4">
                                <div class="card text-white bg-info mb-3">
                                    <div class="card-header" style="color: black">PAR 14 Days</div>
                                    <div class="card-body">
                            ...
                            <div class="col-md-4">
                                <div class="card text-white bg-info mb-3">
                                    <div class="card-header" style="color: black">PAR 21 Days</div>
                                    <div class="card-body">
