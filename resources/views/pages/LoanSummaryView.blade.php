...
<div class="page-footer">
    <hr>
    Page <span class="page-number"></span> : Facilities Approval Form : {{ $loan->Loan_No }}
</div>


<h2>Facilities Approval Form</h2>
<br>
<div class="card">
                ...
                <table class="table table-bordered table-sm table-striped">
                    ...
                    @foreach ($installments as $installment)
                        @php
                            ...
                            } elseif ($installment->Status == 0 && Carbon::parse($installment->Installment_Date)->isPast()) {
            ...
            <tr>
                <td>
                    <div style="text-align: center; flex: 1; margin-right: 20px;">
                        ...
                        <div style="border: 1px solid #000; height: 50px; width: 200px; margin: 0 auto;"></div>
                        <p>Date: ___________</p>
                    </div>
                    <td>
                    <div style="text-align: center; flex: 1;">
                        <p><strong>Lending Officer Signature</strong></p>
                        <div style="border: 1px solid #000; height: 50px; width: 200px; margin: 0 auto;"></div>
                        <p>Date: ___________</p>
                    </div>
                </td>
...
{{--        <div class="card-body" style="display: flex; justify-content: space-between; padding: 20px;">--}}
{{--            <div style="text-align: center; flex: 1; margin-right: 20px;">--}}
{{--                <p><strong>Borrower Signature</strong></p>--}}
{{--                <div style="border: 1px solid #000; height: 50px; width: 200px; margin: 0 auto;"></div>--}}
{{--                <p>Date: ___________</p>--}}
