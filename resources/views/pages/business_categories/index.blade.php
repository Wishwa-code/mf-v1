            ...
            <div class="col-12">
                <div class="card card-modern">
                    <div class="card-header d-flex justify-content-between align-items-center bg-white border-bottom-0 pt-4 px-4">
                        <h4 class="header-title mb-0 fw-bold text-dark">Business Categories List</h4>
                        <button type="button" class="btn btn-primary rounded-pill px-4" id="createNewCategory">
                            <i class="bi bi-plus-lg me-1"></i> Add New Category
                        </button>
                    </div>
                    <div class="card-body px-4 pb-4">
                        <div class="table-responsive">
                            <table id="categoryTable" class="table table-modern table-borderless dt-responsive nowrap w-100">
                                <thead>
                                    <tr>
                                        <th width="5%">#</th>
                                        <th>Category Name</th>
