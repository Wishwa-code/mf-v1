        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box">
                    <h4 class="page-title">Penalty Balance</h4>
                    <p class="mb-0 text-muted">Active loans with penalty balances</p>
                </div>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-centered mb-0" id="penalty_balance_table">
                                ...
                                <tbody>
                                    @foreach($penaltyBalanceData as $item)
                                        <tr>
                                            <td>{{ $item->loan_id }}</td>
                                            ...
                                            <td class="text-right">{{ number_format($item->total_outstanding, 2) }}</td>
                                            <td class="text-right"><strong>{{ number_format($item->penalty_balance, 2) }}</strong></td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            $('#penalty_balance_table').DataTable({
                dom: 'Bfrtip',
                buttons: [
                    {
                        extend: 'excel',
