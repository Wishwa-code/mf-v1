        ...
        <div class="col-12">
            <div class="card report-card">
                <div class="card-body">
                    <form method="GET" action="{{ route('arrears.index') }}" class="filter-shell">
                        <div class="row g-3 align-items-end">
                            <div class="col-lg-3 col-md-6">
                                ...
                                <input type="text" id="from" name="from" class="form-control flatpickr-input" placeholder="Select Date" value="{{ request('from', \Carbon\Carbon::now()->startOfMonth()->toDateString()) }}">
                            </div>
                            <div class="col-lg-3 col-md-6">
                                <label for="to" class="form-label fw-semibold">To</label>
                                <input type="text" id="to" name="to" class="form-control flatpickr-input" placeholder="Select Date" value="{{ request('to', \Carbon\Carbon::now()->toDateString()) }}">
                            </div>
                            <div class="col-lg-3 col-md-6">
                    ...
                    foreach($data as $row) {
                    $totals['Total_Due_Amount'] += $row['Total_Due_Amount'];
                    $totals['Collected_Total_Amount'] += $row['Collected_Total_Amount'];
                        ...
                        <table class="table table-bordered table-hover table-sm report-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ number_format($row['Total_Due_Amount'], 2) }}</td>
                                    <td>{{ number_format($row['Collected_Total_Amount'], 2) }}</td>
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <th class="text-end">{{ number_format($totals['Total_Due_Amount'], 2) }}</th>
                                    <th class="text-end">{{ number_format($totals['Collected_Total_Amount'], 2) }}</th>
