    ...
    <script>
        $(document).ready(function () {
            ...
            $('#searchOption').change(function () {
                ...
                $.ajax({
                    url: '/get-account-trialBalance-data',  // Adjust the URL as needed
                    type: 'GET',
                    data: { searchOption: selectedOption },
                ...
                `);
                            ...
                            data.forEach(function (item) {
                                ...
                                var code = item.acc_code ? item.acc_code : 'N/A';
                                var accName = item.acc_name ? item.acc_name : 'N/A';
