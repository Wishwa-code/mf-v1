        ...
        <form class="row g-3 mb-4">
            ...
            <div class="col-md-6">
                <select id="searchOption" class="form-control">
                    ...
                    <option value="oneYear">Current Financial Year</option>
                    <option value="twoYear">Last Two Financial Years</option>
                    <option value="threeYear">Last Three Financial Years</option>
                    <option value="fourYear">Last Four Financial Years</option>
                </select>
            </div>
        </form>
